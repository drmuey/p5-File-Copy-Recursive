...
diag(
"Testing legacy File::Copy::Recursive::pathmk() $File::Copy::Recursive::VERSION"
);
...
if ($^O eq 'MSWin32') {
  ...
  is(translate_to_unc('C:/foo/bar.txt'), '//127.0.0.1/C$/foo/bar.txt',
     'translate_to_unc /');
  is(translate_to_unc('C:\\foo\\bar.txt'),
